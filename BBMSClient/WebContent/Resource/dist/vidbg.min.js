...
!function(e, t) {
    ...
    function e(e) {
        ...
        p = 0,
        a = s.length; a > p && (i = s[p],
        -1 === i.search(/^(http|https|ftp):\/\//) && -1 !== i.search(":")); p++)
            o = i.indexOf(":"),
            r = i.substring(0, o),
            n = i.substring(o + 1),
            n || (n = void 0),
    ...
    function t(e) {
        e = "" + e;
        var t = e.split(/\s+/), o = "50%", i = "50%", r, n, s;
        for (s = 0,
        r = t.length; r > s; s++)
            n = t[s],
            "left" === n ? o = "0%" : "right" === n ? o = "100%" : "top" === n ? i = "0%" : "bottom" === n ? i = "100%" : "center" === n ? 0 === s ? o = "50%" : i = "50%" : 0 === s ? o = n : i = n;
        return {
            x: o,
            y: i
        }
    ...
    i.prototype.init = function() {
        var e = this, i = e.path, n = i, a = "", p = e.$element, d = e.settings, c = t(d.position), u, l;
        ...
        "object" == typeof i && (i.poster ? n = i.poster : i.mp4 ? n = i.mp4 : i.webm && (n = i.webm)),
        l.css("background-image", "url(" + n + ")"),
        ...
        p.prepend(l),
        "object" == typeof i ? (i.mp4 && (a += '<source src="' + i.mp4 + '" type="video/mp4">'),
        i.webm && (a += '<source src="' + i.webm + '" type="video/webm">'),
        u = e.$video = $("<video>" + a + "</video>")) : u = e.$video = $('<video><source src="' + i + '" type="video/mp4"><source src="' + i + '" type="video/webm"></video>');
        try {
            u.prop({
                autoplay: d.autoplay,
                loop: d.loop,
        ...
        l.append(u),
        d.overlay && $("<div class='vidbg-overlay' style='position:absolute;top:0;right:0;left:0;bottom:0;background: rgba(" + o(d.overlayColor).r + ", " + o(d.overlayColor).g + ", " + o(d.overlayColor).b + ", " + d.overlayAlpha + ")'></div>").insertAfter($(".vidbg-container > video"))
    }
    ,
    ...
    $(document).ready(function() {
        ...
        e.on("resize." + r, function() {
            for (var e = $[r].lookup.length, t = 0, o; e > t; t++)
                o = $[r].lookup[t],
                o && o.settings.resizing && o.resize()
        }),
